 ...
 */
public class SwerveControllerCommandWithTelemetry extends CommandBase {
  private final Timer m_timer = new Timer();
  private final Trajectory m_trajectory;
  private final Supplier<Pose2d> m_pose;
  private final SwerveDriveKinematics m_kinematics;
  private final HolonomicDriveControllerWithTelemetry m_controller;
   ...
   */
  public SwerveControllerCommandWithTelemetry(
    ...
    this(
        ...
        pose,
        kinematics,
        new HolonomicDriveControllerWithTelemetry(
  ...
  public SwerveControllerCommandWithTelemetry(
      ...
      Supplier<Pose2d> pose,
      SwerveDriveKinematics kinematics,
      HolonomicDriveControllerWithTelemetry controller,
      Consumer<SwerveModuleState[]> outputModuleStates,
      Subsystem... requirements) {
    this(
        trajectory,
